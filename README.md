...
Below is shown the transition of the resblocks to resblocks with adapter inserted. The first image is the regular resblock and the second is with the adaper inserted.
