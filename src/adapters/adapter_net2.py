...
from adapters.adapter_block_up import ResidualAdapterBlockUp
from adapters.adapter_block_stride import ResidualAdapterBlockStride

class AdapterNetAll(JointAutoregressiveHierarchicalPriors):
    def __init__(self, N=128, v=3, R=2, **kwargs):
        super().__init__(N=N, M=N, **kwargs)

        self.g_a = nn.Sequential(
            ResidualAdapterBlockStride(3, N, v, R, stride=2),
            ResidualAdapterBlock(N, N, v, R),
            ResidualAdapterBlockStride(N, N, v, R, stride=2),
            ResidualAdapterBlock(N, N, v, R),
            ResidualAdapterBlockStride(N, N, v, R, stride=2),
            ResidualAdapterBlock(N, N, v, R),
        ...
        self.g_s = nn.Sequential(
            ResidualAdapterBlock(N, N, v, R),
            ResidualAdapterBlockUp(N, N, v, R, 2),
            ResidualAdapterBlock(N, N, v, R),
            ResidualAdapterBlockUp(N, N, v, R, 2),
            ResidualAdapterBlock(N, N, v, R),
            ResidualAdapterBlockUp(N, N, v, R, 2),
